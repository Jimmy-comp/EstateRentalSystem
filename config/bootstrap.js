...
module.exports.bootstrap = async function () {
  ...
  if (await Estate.count() == 0) {
    await Estate.createEach([
      ...
      { title: "全港最貴", estatename: "Heng Fa Chuen", district: "Chai Wan", area: 100, rent: 17000, url: "https://d1hy6t2xeg0mdl.cloudfront.net/image/498087/ec8f97f3a7/standard", roomnum: 3, tenants: 5, highlightprop: "true" },
      { title: "無敵大海景", estatename: "Victoria Harbour", district: "North Point", area: 300, rent: 30000, url: "https://www.victoriaharbourresidence.com/images/room/3bed-hero-2.jpg", roomnum: 3, tenants: 3, highlightprop: "true" },
